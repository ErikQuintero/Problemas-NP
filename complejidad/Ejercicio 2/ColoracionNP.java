...
public class ColoracionNP {
	...
	public static void main(String [] args){
        ...
        if(opcion.equals("1")){ 
            ...
            ejemplar.dirigidaNo();
            ejemplar.generaColores();
            boolean si = ejemplar.faseVerificacion();
            System.out.print("\nLa grafica a colorear es: ");
            System.out.print("\n"+ ejemplar.toString());
            System.out.print("\nEl candidato a solucion es: ");
            System.out.print("\n"+ ejemplar.toStringColor());
            if(si){
            ...
            //En esta seccion del codigo se genera la grafica proporcionada por el usuario y se ejecuta el algoritmo de coloracion
            ...
            //no afecta como tal al algoritmo de coloracion NP
